...
Namespace WpfApplication
    Public NotInheritable Class CellsHighlightHelper
        Public Shared ReadOnly CellsToHighlightProperty As DependencyProperty = DependencyProperty.RegisterAttached("CellsToHighlight", GetType(ObservableCollection(Of HighlightedGridCell)), GetType(CellsHighlightHelper), Nothing)
